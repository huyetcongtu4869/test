...
@section('content')
<form action="{{route('service.store',['product' => $product])}}" method="POST" class="row justify-content-center" id="container">
    @csrf
    <div class="row justify-content-center pb-10">
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="input" name="name_product" value="{{$product->name_product}}" class="form-control" disabled>
                    </div>
                    <div class="mb-3">
        ...
        <div class="col-md-8 hstack gap-2 justify-content-between mt-3">
            ...
            <div>
                ...
                <button id="js_btn_submit" class="btn btn-success" type="submit">Lưu</button>
            </div>
        </div>
    </div>
</form>
